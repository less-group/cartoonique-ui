...
(function() {
  ...
  // Create and append the instructions popup if it doesn't exist
  function ensureInstructionsPopupExists() {
    ...
    document.getElementById('pixar-upload-button').addEventListener('click', function() {
      ...
      // Always ensure the instructions popup exists
      ensureInstructionsPopupExists();
    ...
    console.log('⭐ Instructions and loading popups created and added to document');
  }

  // Wait for DOM to be ready
  document.addEventListener('DOMContentLoaded', function() {
    // Ensure popups exist right after DOM is ready
    ensureInstructionsPopupExists();
    ...
    if (componentContainer) {
      ...
      // Override openPopup method to use our enhanced popup
      pixarComponent.openPopup = function() {
        ...
        if (instructionsPopup) {
          ...
          console.log('⭐ Instructions popup not found in override');
        }
      };
