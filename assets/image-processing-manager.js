...
class ImageProcessingManager {
  ...
  showTextOverlay() {
    ...
    const prevPopUp = document.getElementById("image-cropper-container");
    if (prevPopUp && prevPopUp.style.display === "block") {
      prevPopUp.style.display = "none";
    }
    ...
    try {
      ...
      if (mainImage) {
        ...
        if (!mainImage.dataset.originalStyles) {
          ...
          mainImage.dataset.originalSrc = JSON.stringify({
            src: mainImage.src,
  ...
  getCroppedImageFromDOM() {
    try {
      ...
      console.log(
        `🐀񿈏 Using crop coordinates X:${this.croppedImageX}, Y:${this.croppedImageY}, W:${this.croppedImageWidth}, H:${this.croppedImageHeight}`
      );
